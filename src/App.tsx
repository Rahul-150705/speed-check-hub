      ...
      <div className="p-10">
        {page === "home" && (
          <div className="text-center">
            ...
            <p className="text-lg text-gray-700">Click the floating icon to check your internet speed in real-time!</p>
          </div>
        )}
        {page === "about" && (
          <div className="max-w-2xl mx-auto text-gray-700 text-lg">
            ...
            <p>
              This app measures your internet speed in real-time using a FastAPI backend and displays the results with a beautiful React + Tailwind frontend. The floating speed icon updates every 2-3 seconds for continuous monitoring.
            </p>
          </div>
        )}
      </div>

      {/* Floating Speed Test Icon */}
      <SpeedTestFloat />
    </div>
  );
}
